/**
 * RequestTemplateListWithDocumentFields.java
 *
...
public class RequestTemplateListWithDocumentFields  implements java.io.Serializable {
    private java.lang.String[] templateIDs;

    private boolean includeDocumentBytes;

    public RequestTemplateListWithDocumentFields() {
    }
    ...
    /**
     * Gets the templateIDs value for this RequestTemplateListWithDocumentFields.
     * 
     * @return templateIDs
     */
    ...
    /**
     * Sets the templateIDs value for this RequestTemplateListWithDocumentFields.
     * 
     * @param templateIDs
     */
    ...
    /**
     * Gets the includeDocumentBytes value for this RequestTemplateListWithDocumentFields.
     * 
    ...
    /**
     * Sets the includeDocumentBytes value for this RequestTemplateListWithDocumentFields.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof RequestTemplateListWithDocumentFields)) return false;
        RequestTemplateListWithDocumentFields other = (RequestTemplateListWithDocumentFields) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(RequestTemplateListWithDocumentFields.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.docusign.net/API/3.0", ">RequestTemplateListWithDocumentFields"));
