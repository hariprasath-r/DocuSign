...
public class TabTypeCode implements java.io.Serializable {
    ...
    public static final java.lang.String _SignerAttachmentOptional = "SignerAttachmentOptional";
    ...
    public static final TabTypeCode FirstName = new TabTypeCode(_FirstName);
    public static final TabTypeCode LastName = new TabTypeCode(_LastName);
    public static final TabTypeCode EmailAddress = new TabTypeCode(_EmailAddress);
    ...
    public static final TabTypeCode Approve = new TabTypeCode(_Approve);
    public static final TabTypeCode Decline = new TabTypeCode(_Decline);
    public static final TabTypeCode SignerAttachmentOptional = new TabTypeCode(_SignerAttachmentOptional);
