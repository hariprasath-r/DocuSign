/**
 * DeleteCaptiveRecipientsSignaturesArg.java
 *
...
public class DeleteCaptiveRecipientsSignaturesArg  implements java.io.Serializable {
    private net.docusign.www.API._3_0.CaptiveRecipient[] captiveRecipients;

    public DeleteCaptiveRecipientsSignaturesArg() {
    }
    ...
    /**
     * Gets the captiveRecipients value for this DeleteCaptiveRecipientsSignaturesArg.
     * 
    ...
    /**
     * Sets the captiveRecipients value for this DeleteCaptiveRecipientsSignaturesArg.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof DeleteCaptiveRecipientsSignaturesArg)) return false;
        DeleteCaptiveRecipientsSignaturesArg other = (DeleteCaptiveRecipientsSignaturesArg) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(DeleteCaptiveRecipientsSignaturesArg.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.docusign.net/API/3.0", "DeleteCaptiveRecipientsSignaturesArg"));
        ...
        elemField.setItemQName(new javax.xml.namespace.QName("http://www.docusign.net/API/3.0", "CaptiveRecipient"));
