...
public class DeliveryMethod implements java.io.Serializable {
    ...
    public static final DeliveryMethod Email = new DeliveryMethod(_Email);
    public static final DeliveryMethod Fax = new DeliveryMethod(_Fax);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.docusign.net/API/3.0", "DeliveryMethod"));
    }
    /**
