...
public class RecipientCorrection  implements java.io.Serializable {
    ...
    private net.docusign.www.API._3_0.DeliveryMethod correctedDeliveryMethod;

    private java.lang.String correctedFaxNumber;
    ...
    public RecipientCorrection(
           ...
           net.docusign.www.API._3_0.DeliveryMethod correctedDeliveryMethod,
           java.lang.String correctedFaxNumber) {
           ...
           this.resend = resend;
           this.correctedDeliveryMethod = correctedDeliveryMethod;
           this.correctedFaxNumber = correctedFaxNumber;
    }
    ...
    /**
     * Gets the correctedDeliveryMethod value for this RecipientCorrection.
     * 
     * @return correctedDeliveryMethod
     */
    public net.docusign.www.API._3_0.DeliveryMethod getCorrectedDeliveryMethod() {
        return correctedDeliveryMethod;
    }


    /**
     * Sets the correctedDeliveryMethod value for this RecipientCorrection.
     * 
     * @param correctedDeliveryMethod
     */
    public void setCorrectedDeliveryMethod(net.docusign.www.API._3_0.DeliveryMethod correctedDeliveryMethod) {
        this.correctedDeliveryMethod = correctedDeliveryMethod;
    }


    /**
     * Gets the correctedFaxNumber value for this RecipientCorrection.
     * 
     * @return correctedFaxNumber
     */
    public java.lang.String getCorrectedFaxNumber() {
        return correctedFaxNumber;
    }


    /**
     * Sets the correctedFaxNumber value for this RecipientCorrection.
     * 
     * @param correctedFaxNumber
     */
    public void setCorrectedFaxNumber(java.lang.String correctedFaxNumber) {
        this.correctedFaxNumber = correctedFaxNumber;
    }
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        ...
        _equals = true && 
            ...
            ((this.correctedDeliveryMethod==null && other.getCorrectedDeliveryMethod()==null) || 
             (this.correctedDeliveryMethod!=null &&
              this.correctedDeliveryMethod.equals(other.getCorrectedDeliveryMethod()))) &&
            ((this.correctedFaxNumber==null && other.getCorrectedFaxNumber()==null) || 
             (this.correctedFaxNumber!=null &&
              this.correctedFaxNumber.equals(other.getCorrectedFaxNumber())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getCorrectedDeliveryMethod() != null) {
            _hashCode += getCorrectedDeliveryMethod().hashCode();
        }
        if (getCorrectedFaxNumber() != null) {
            _hashCode += getCorrectedFaxNumber().hashCode();
        }
    ...
    static {
        ...
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("correctedDeliveryMethod");
        elemField.setXmlName(new javax.xml.namespace.QName("http://www.docusign.net/API/3.0", "CorrectedDeliveryMethod"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.docusign.net/API/3.0", "DeliveryMethod"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("correctedFaxNumber");
        elemField.setXmlName(new javax.xml.namespace.QName("http://www.docusign.net/API/3.0", "CorrectedFaxNumber"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
